...
<a {{ $attributes->merge(['class' => 'max-md:hidden md:inline-flex uppercase cursor-default items-center px-1 pt-1 text-sm tracking-widest leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out']) }}>
    <div class="{{ $classes }}">
        {{ $slot }}
    </div>
</a>
