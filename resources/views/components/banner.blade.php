<div class="text-xl md:text-3xl leading-snug text-center p-6 pb-10 md:pb-20 text-black">
    ...
    <a class="link" href="/tags/aws">aws</a> and other
    <a class="link" href="/tags">interesting topics</a>.
</div>
