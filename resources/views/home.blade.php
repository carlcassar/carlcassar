    ...
    <x-card class="mt-8">
        <div
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400 leading-relaxed">
                I'm @carlcassar on Twitter, Instagram and Github . I make websites and apps. I write articles and love
                to
                read books. Stick around if you're interested in php, laravel, javascript, aws and other interesting
                topics.
            </p>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                    ...
                    the
                    framework or have previous experience, we recommend reading all of the documentation from beginning
                    to
                    end.
                </p>
