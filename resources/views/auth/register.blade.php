        ...
        <div class="block mt-4">
            <label for="notifications" class="inline-flex items-center">
                <input id="notifications" type="checkbox"
                       ...
                       name="notifications">
                <span
                    class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('I would like to receive email notifications about account changes, new articles, products and services. Opt out at any time.') }}</span>
            </label>
        </div>
